...
const pluginId = "quicker-wheel";
const targetDir =
  process.env.OBSIDIAN_QUICKER_TARGET ??
  "/Users/yangjiahao/Documents/Steamboy/.obsidian/plugins/quicker-wheel";
...
function mentionsPluginNotFound(result) {
  return /Plugin "quicker-wheel" not found|Plugin .* not found/i.test(result.output);
}
